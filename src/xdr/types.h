...
template<> struct xdr_traits<::stellar::LedgerVersion>
  ...
  static const char *enum_name(::stellar::LedgerVersion val) {
    ...
    case ::stellar::LedgerVersion::FIX_UNORDERED_FEE_DESTINATION:
    ...
    case ::stellar::LedgerVersion::FIX_UPDATE_DATA_OWNER_RESULT:
      return "FIX_UPDATE_DATA_OWNER_RESULT";
    default:
      return nullptr;
    }
  }
  static const std::vector<int32_t> &enum_values() {
    static const std::vector<int32_t> _xdr_enum_vec = {
      ...
      (int32_t)::stellar::LedgerVersion::FIX_UPDATE_DATA_OWNER_RESULT
    };
