// -*- C++ -*-
// Automatically generated from operation-cancel-sale-creation-request.x.
// DO NOT EDIT or your changes may be overwritten

#ifndef __XDR_OPERATION_CANCEL_SALE_CREATION_REQUEST_H_INCLUDED__
#define __XDR_OPERATION_CANCEL_SALE_CREATION_REQUEST_H_INCLUDED__ 1
...
struct CancelSaleCreationRequestOp  : xdr::xdr_abstract {
...
struct CancelSaleCreationSuccess  : xdr::xdr_abstract {
  struct _ext_t : xdr::xdr_abstract {
    using _xdr_case_type = xdr::xdr_traits<LedgerVersion>::case_type;
  private:
    _xdr_case_type v_;
...
struct CancelSaleCreationRequestResult : xdr::xdr_abstract {
...
else {this->~CancelSaleCreationRequestResult();
    code_ = source.code_;
switch (code_)
{
    case (int32_t)CancelSaleCreationRequestResultCode::SUCCESS:
...
#endif // !__XDR_OPERATION_CANCEL_SALE_CREATION_REQUEST_H_INCLUDED__
