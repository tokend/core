...
SignerRuleResource::_liquidityPool_t::from_bytes(xdr::unmarshaler& u) 
{
...
bool
SignerRuleResource::_liquidityPool_t::to_bytes(xdr::marshaler& m) const 
{
...
void
SignerRuleResource::_liquidityPool_t::count_size(xdr::measurer& m) const 
{
...
bool
SignerRuleResource::_liquidityPool_t::operator==(xdr::xdr_abstract const& other_abstract) const 
{
if (typeid(*this) != typeid(other_abstract))
{
return false;
...
;}
bool
SignerRuleResource::_liquidityPool_t::operator<(xdr_abstract const& other_abstract) const
{
if (typeid(*this) != typeid(other_abstract))
{
throw std::runtime_error("unexpected operator< invoke");
