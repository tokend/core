// -*- C++ -*-
// Automatically generated from Stellar-ledger-entries-fee.x.
// DO NOT EDIT or your changes may be overwritten

#ifndef __XDR_STELLAR_LEDGER_ENTRIES_FEE_H_INCLUDED__
#define __XDR_STELLAR_LEDGER_ENTRIES_FEE_H_INCLUDED__ 1
...
template<> struct xdr_traits<::stellar::FeeEntry::_ext_t> : xdr_traits_base {
  static Constexpr const bool is_class = true;
  static Constexpr const bool is_union = true;
  static Constexpr const bool has_fixed_size = false;

  using union_type = ::stellar::FeeEntry::_ext_t;
  using case_type = ::stellar::FeeEntry::_ext_t::_xdr_case_type;
  ...
  static std::size_t serial_size(const ::stellar::FeeEntry::_ext_t &obj) {
    std::size_t size = 0;
  ...
  save(Archive &ar, const ::stellar::FeeEntry::_ext_t &obj) {
  ...
  template<typename Archive> static void
  load(Archive &ar, ::stellar::FeeEntry::_ext_t &obj) {
...
template<> struct xdr_traits<::stellar::FeeEntry>
  : xdr_struct_base<field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::feeType),
                              &::stellar::FeeEntry::feeType>,
                    field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::asset),
                              &::stellar::FeeEntry::asset>,
                    field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::fixedFee),
                              &::stellar::FeeEntry::fixedFee>,
                    field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::percentFee),
                              &::stellar::FeeEntry::percentFee>,
                    field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::accountID),
                              &::stellar::FeeEntry::accountID>,
                    field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::accountRole),
                              &::stellar::FeeEntry::accountRole>,
                    field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::subtype),
                              &::stellar::FeeEntry::subtype>,
                    field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::lowerBound),
                              &::stellar::FeeEntry::lowerBound>,
                    field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::upperBound),
                              &::stellar::FeeEntry::upperBound>,
                    field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::hash),
                              &::stellar::FeeEntry::hash>,
                    field_ptr<::stellar::FeeEntry,
                              decltype(::stellar::FeeEntry::ext),
                              &::stellar::FeeEntry::ext>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::FeeEntry &obj) {
    archive(ar, obj.feeType, "feeType");
    archive(ar, obj.asset, "asset");
    archive(ar, obj.fixedFee, "fixedFee");
    archive(ar, obj.percentFee, "percentFee");
    archive(ar, obj.accountID, "accountID");
    archive(ar, obj.accountRole, "accountRole");
    archive(ar, obj.subtype, "subtype");
  ...
  template<typename Archive> static void
  load(Archive &ar, ::stellar::FeeEntry &obj) {
    archive(ar, obj.feeType, "feeType");
    archive(ar, obj.asset, "asset");
    archive(ar, obj.fixedFee, "fixedFee");
    archive(ar, obj.percentFee, "percentFee");
...
#endif // !__XDR_STELLAR_LEDGER_ENTRIES_FEE_H_INCLUDED__
