// -*- C++ -*-
// Automatically generated from reviewable-request-issuance.x.
// DO NOT EDIT or your changes may be overwritten

#ifndef __XDR_REVIEWABLE_REQUEST_ISSUANCE_H_INCLUDED__
#define __XDR_REVIEWABLE_REQUEST_ISSUANCE_H_INCLUDED__ 1
...
struct PreIssuanceRequest  : xdr::xdr_abstract {
...
struct IssuanceRequest  : xdr::xdr_abstract {
  struct _ext_t : xdr::xdr_abstract {
    using _xdr_case_type = xdr::xdr_traits<LedgerVersion>::case_type;
  private:
    _xdr_case_type v_;
...
#endif // !__XDR_REVIEWABLE_REQUEST_ISSUANCE_H_INCLUDED__
