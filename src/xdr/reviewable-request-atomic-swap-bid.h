// -*- C++ -*-
// Automatically generated from reviewable-request-atomic-swap-bid.x.
// DO NOT EDIT or your changes may be overwritten

#ifndef __XDR_REVIEWABLE_REQUEST_ATOMIC_SWAP_BID_H_INCLUDED__
#define __XDR_REVIEWABLE_REQUEST_ATOMIC_SWAP_BID_H_INCLUDED__ 1
...
struct CreateAtomicSwapBidRequest  : xdr::xdr_abstract {
...
count_size(xdr::measurer& m) const override;
  ...
  CreateAtomicSwapBidRequest() = default;
  template<typename _askID_T,
           ...
           std::enable_if<std::is_constructible<uint64, _askID_T>::value
                         ...
                         >::type>
  explicit CreateAtomicSwapBidRequest(_askID_T &&_askID,
...
#endif // !__XDR_REVIEWABLE_REQUEST_ATOMIC_SWAP_BID_H_INCLUDED__
