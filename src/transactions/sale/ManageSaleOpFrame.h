...
public:
    ...
    static void cancelSale(SaleFrame::pointer sale, StorageHelper& storageHelper, LedgerManager& lm);
    ...
    static void unlockPendingIssuance(StorageHelper& storageHelper, AssetCode const& code, uint64_t const& amount);
