...
class MockAccountKYCHelper : public AccountKYCHelper
{
public:
    ...
    MOCK_METHOD2(storeUpdate, void(const LedgerEntry& entry, bool insert));
    MOCK_METHOD1(loadAccountKYC, AccountKYCFrame::pointer(const AccountID &accountID));
};
