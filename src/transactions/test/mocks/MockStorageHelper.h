...
namespace stellar {
    ...
    public:
        ...
        MOCK_CONST_METHOD0(getLedgerDelta,
                           const LedgerDelta*());
        MOCK_METHOD0(mustGetLedgerDelta,
                     LedgerDelta&());
        MOCK_CONST_METHOD0(mustGetLedgerDelta,
                           const LedgerDelta&());
        MOCK_METHOD0(commit,
                     void());
        ...
        MOCK_METHOD0(getAccountHelper,
                     AccountHelper&());
        MOCK_METHOD0(getAccountRoleHelper,
                     AccountRoleHelper&());
        MOCK_METHOD0(getAccountRuleHelper,
                     AccountRuleHelper&());
        MOCK_METHOD0(getSignerHelper,
                     SignerHelper&());
        MOCK_METHOD0(getSignerRuleHelper,
                     SignerRuleHelper&());
