...
TEST_CASE_METHOD(HistoryTests, "next checkpoint ledger", "[history][next_check_ledger]")
{
...
TEST_CASE_METHOD(HistoryTests, "HistoryManager::compress", "[history][compress]")
{
...
HistoryTests::generateAndPublishHistory(size_t nPublishes)
{
    ...
    auto ledgerSeq = lm.getCurrentLedgerHeader().ledgerSeq;
