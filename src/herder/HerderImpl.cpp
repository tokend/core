                              ...
                              std::set<Value> const& candidates)
{
    ...
    StellarValue comp(h, 0, emptyUpgradeSteps, StellarValue::_ext_t(LedgerVersion::EMPTY_VERSION));
...
HerderImpl::TxMap::recalculate()
{
    ...
    {
        mTotalFees += pair.second->getPaidFee();
    }
}
